...
export default function LayoutComponet() {
  ...
  useEffect(() => {
    ...
    //     if (data.order ==) // 동작 중 : 0, 동작 완료 : 1, 오류 발생 :2 -> 어케할지 재민이랑 얘기
  ...
  return (
    <StyledLayout>
      ...
      <FooterComponents order={order} setPreviewTurtlebotsPos={setPreviewTurtlebotsPos} setPreview={setPreview} previewTurtlebotsPos={previewTurtlebotsPos} messageOrder={messageOrder} setMessageOrder={setMessageOrder}></FooterComponents>
    </StyledLayout>
  );
}
